                  ...
                  <div>
                     ...
                     <Education>
                        ...
                        <div className="education-style">
                           ...
                           <div className="education-box">
                              <label>{t('finish')}:</label>
                              <p>{resume.education.universityFinish}</p>
                           </div>
                           <div className="education-box">
                              <label>{t('description school')}:</label>
                              <p>{resume.education.descriptionSchool}</p>
                           </div>
                           <div className="education-box">
                              <label>{t('description university')}:</label>

                              <p>{resume.education.descriptionUniversity}</p>
                           </div>
                        </div>
                     </Education>
                  </div>
